    ...
    <main>
      ...
      <article>
        ...
        <dl>
          ...
          <dd>
            <Link
              to="https://github.com/antonym0505/antonym0505.github.io"
              target="_blank"
              style={{
                display: 'flex',
                font: 'inherit',
      ...
      <article>
        ...
        <dl>
          ...
          <dd>
            <ul>
              <li>java&bull;spring&bull;jpa</li>
              <li>python&bull;fastAPI&bull;</li>
              <li>postgres&bull;sql</li>
            </ul>
          </dd>
          <dt>testing</dt>
          <dd>
